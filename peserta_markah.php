<?php
   session_start(); 
    ...
    $kedudukan = 0; $sql = "select * from keputusan join peserta on keputusan.nokp = peserta.nokp join penilaian on keputusan.idpenilaian = penilaian.idpenilaian  join hakim on peserta.idhakim = hakim.idhakim group by peserta.nokp order by keputusan.jumlah desc";
...
?>
    ...
    <table>
         ...
         <?php 
            $sql = "select * from keputusan join penilaian on keputusan.idpenilaian = penilaian.idpenilaian where nokp = '$nokp'
"; 
            $data = mysqli_query($sambungan, $sql); 
            ...
            if ($bilrekod > 0) { 
            	while ($keputusan = mysqli_fetch_array($data)) { 
            		echo "<tr >
                            ...
                            </tr>"; $jumlah_markah = $keputusan['jumlah'];
                }
