...
<?php
   ...
   echo $kepala; 
   $bil = 1; $sql = "select * from keputusan join peserta on keputusan.nokp = peserta.nokp join penilaian on keputusan.idpenilaian = penilaian.idpenilaian join hakim on peserta.idhakim = hakim.idhakim where hakim.idhakim = '$idhakim' order by keputusan.jumlah desc, penilaian.idpenilaian asc ";
